...
public static class Vector2Extensions
{
     ...
     * 按照像素宽度画点
     */
    public static void DrawPoint(this Texture2D tex, int x0, int y0, Color col, int r)
    {
        for (var x = Math.Max(0, x0 - r); x < x0 + r; ++x)
        {
            for (var y = Math.Max(0, y0 - r); y < y0 + r; ++y)
            {
    ...
    public class myReverserClass : IComparer  
    {
        ...
        int IComparer.Compare( object o, object o1 )  {
            return( (new CaseInsensitiveComparer()).Compare( o, o1 ) );
        }
    }
     ...
     * 沿凸边型边画线
     */
    public static void FillLine(this Texture2D texture, Vector2[] points, Color color)
    {
        //Array.Sort(points);
        ...
        for (int i = 1; i < points.Length; i++)
        {
            ...
            texture.DrawLine((int)startpos.x, (int)startpos.y, (int)nextPos.x, (int)nextPos.y, color);
            startpos = nextPos;
        }
    }
